...
@interface SNPXLTunaiResult : SNPPaymentResult <NSCoding, NSCopying>
...
@property (nonatomic, strong) NSString *xlTunaiMerchantId;
@property (nonatomic, strong) NSString *statusMessage;
@property (nonatomic, strong) NSString *xlExpiration;
@property (nonatomic, strong) NSString *statusCode;
@property (nonatomic, strong) NSString *xlTunaiOrderId;
